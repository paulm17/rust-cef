...
pub fn create_app_menu_bar() -> AppMenuHandles {
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        menu.append(&app_menu)
            .expect("Failed to append App Menu to Root");
    ...
    // Dynamic Counter
    let view_counter_item = MenuItem::with_id(MENU_VIEW_COUNTER, "Counter: 0", true, None);
    view_menu
        .append(&view_counter_item)
        .expect("Failed to append Counter");
    ...
    window_menu
        .append(&window_always_on_top_item)
        .expect("Failed to append Always on Top");

    menu.append(&window_menu)
        .expect("Failed to append Window Menu");
    ...
    menu.append(&dialog_menu)
        .expect("Failed to append Dialogs Menu");
